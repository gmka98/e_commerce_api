...
class Business(Model):
    ...
    city = fields.CharField(max_lenght=100, null = False, default = "Unspecified")
    region = fields.CharField(max_lenght=100, null = False, default = "Unspecified")
    Business_description = fields.TextField(null = True )
    logo = fields.CharField(max_lenght=200, null=False, default = "default.jpg")
    owner = fields.ForeignKeyField("models.User", related_name="business")

class Product(Model):
    id = fields.IntField(pk = True, index = True)
    name = fields.CharField(max_lenght=100, null = False, index = True)
    category = fields.CharField(max_lenght=30, index = True)
    ...
    product_image = fields.CharField(max_lenght=200, null = False, default="productDefault.jpg")
